...
public class Queen extends AbstractChessPiece {
    ...
    public void UpdateMoves(ChessBoard board) {
        ...
        this.possibleMoves.addAll(ChessMovement.GetAllPossibleMovesNorth(board, this.isTopSide));
        this.possibleMoves.addAll(ChessMovement.GetAllPossibleMovesSouth(board, this.isTopSide));
