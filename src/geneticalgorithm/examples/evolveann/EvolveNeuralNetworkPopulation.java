 ...
 * @author Tommy
 */
public class EvolveNeuralNetworkPopulation implements RandomPopulationInterface {
    ...
    public EvolveNeuralNetworkPopulation(int populationSize, int startingNodes, int inputNodes, int outputNodes, ProblemInterface fitnessFunction){
